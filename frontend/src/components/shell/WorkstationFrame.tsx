...
export function WorkstationFrame({
  ...
  return (
    <div className="min-h-screen bg-workstation-bg text-workstation-text">
      ...
      <main className="grid min-h-[calc(100vh-3rem)] grid-cols-1 lg:grid-cols-[minmax(0,1fr)_380px]">
        <section className="min-h-[55vh] border-b border-workstation-line lg:border-b-0 lg:border-r">
          {primary}
        </section>
        <aside className="min-h-[45vh] bg-workstation-panel/90">{secondary}</aside>
      </main>
    </div>
  );
}
